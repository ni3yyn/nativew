    ...
    return (
        <Modal transparent visible={visible} animationType="none">
            <View style={styles.modalOverlay}>
                <BlurView  intensity={7} style={StyleSheet.absoluteFill} tint="extraLight" renderToHardwareTextureAndroid />
                <Animated.View style={[
                    styles.alertContainer, 
                    { opacity: opacityAnim, transform: [{ scale: scaleAnim }] }
                ]}>
                    <BlurView  intensity={7} tint="extraLight" style={[styles.alertGlass, { backgroundColor: COLORS.glassTint }]}>
...
const PromoSlider = () => {
    ...
    return (
        <View style={styles.sliderOuterContainer}>
            <BlurView  intensity={7} tint="extraLight" style={[styles.sliderGlass, { backgroundColor: COLORS.glassTint }]} >
                <Animated.ScrollView
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{flex: 1}}>
          <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.formOuterContainer}>
                <BlurView  intensity={4} tint="extraLight" style={[styles.formGlass, { backgroundColor: COLORS.glassTint }]} renderToHardwareTextureAndroid>
